---
title: "Lesson 3.1: Quarto for Reproducible Reports"
...
Thankfully, we can build a report that meets all of our needs, a Quarto report. RStudio includes a basic template of one for us to work with. **NOTE: if at any point RStudio prompts you to download a package, do it.**

## Setting up a Basic Qurto File

> Exercise: Go to "File" > "New File" > "Quarto Document...".

This window appears, giving us some options:

![](images/rmd_new_quarto_options.png)
...
3. Today's date: `date: "format(Sys.time(), '%b %d, %Y')"`
...
> Exercise: Save the report. **Mac Users:** make sure you add `.qmd` to the end of the file name.


## Render your Report
Now that you have saved the Quarto file, you can "Render" your report.

> Exercise: Render your report. This may require you to install some packages, so click "OK" on the installation popup.
