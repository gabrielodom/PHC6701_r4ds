...
- Watch: <https://www.youtube.com/playlist?list=PLHKz7LkI0oR3JAl4HSPCzFRpIr6KSgrOZ>
- Read: The "Workflow" chapters of **R for Data Science**.  
    ...
    + About how to organize your computer: <https://pose.open.ubc.ca/open-research/open-workflows/best-practices-for-organizing/>
- Do: 
    + Draft an organization schema for your computer files
    + Create an RStudio project for this class in your folder for this class; save it on the desktop for now
    + Organize your school/work-related files into folders by class and/or project (*this should take you a few hours up to a day*)
    + Move your folder and project for this class to the appropriate place on your computer (*per the organization schema you created*)
