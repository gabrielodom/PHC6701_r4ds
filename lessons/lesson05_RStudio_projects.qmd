...
Just like we use a word processor when writing an essay, we use an IDE when writing code. Here is the layout of the RStudio IDE. ![](http://r4ds.had.co.nz/diagrams/rstudio-editor.png)
